-- Multi-Region Event Logs Schema
-- Demonstrates hybrid locality approach:
--   - account_info: computed locality (smart client partitioning)
--   - All other tables: REGIONAL BY ROW (MR abstractions, auto-home via gateway)

-- Multi-region database setup (run these commands first if not already configured):
...
-- =============================================================================
-- ACCOUNT_INFO - Uses computed locality (smart client partitioning)
-- =============================================================================
-- This table requires client to compute locality hash to avoid cross-region UUID checks
...
CREATE TABLE account_info (
    ...
    -- Client must compute this using: crc32ieee(account_id::BYTES) mod 30
...
-- =============================================================================
-- REQUEST_INFO - Uses REGIONAL BY ROW (auto-home via gateway)
-- =============================================================================
...
-- =============================================================================
-- REQUEST_EVENT_LOG - Append-only event stream, REGIONAL BY ROW
-- =============================================================================
...
-- =============================================================================
-- REQUEST_STATUS_HEAD - Current state projection, REGIONAL BY ROW
-- =============================================================================
...
-- =============================================================================
-- TRADE_INFO - Generated instructions, REGIONAL BY ROW
-- =============================================================================
...
ON trade_info (account_id, created_ts DESC)
