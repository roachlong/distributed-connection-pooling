...
public partial class EventLogsContext : DbContext
{
    public EventLogsContext()
    {
    }

    public EventLogsContext(DbContextOptions<EventLogsContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<GeographyColumns> GeographyColumns { get; set; }
    ...
    {
        // Connection string is configured externally via DbContextOptionsBuilder in Program.cs
        // Do not configure here to allow runtime configuration via appsettings.json and environment variables
        if (!optionsBuilder.IsConfigured)
        {
            // Fallback for tooling (migrations, etc.) - not used at runtime
            optionsBuilder.UseNpgsql("Host=localhost;Port=26257;Database=defaultdb;Username=root;SSL Mode=Prefer;Root Certificate=../../../certs/ca.crt;SSL Certificate=../../../certs/client.root.crt;SSL Key=../../../certs/client.root.key");
        }
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<GeographyColumns>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("geography_columns", "pg_extension", tb => tb.HasComment("Shows all defined geography columns. Matches PostGIS' geography_columns functionality."));
        ...
        modelBuilder.Entity<GeometryColumns>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("geometry_columns", "pg_extension", tb => tb.HasComment("Shows all defined geometry columns. Matches PostGIS' geometry_columns functionality."));
        ...
        modelBuilder.Entity<RequestActionStateLink>(entity =>
        {
            ...
            entity
                .ToTable("request_action_state_link", tb => tb.HasComment("Calculates slope of the least-squares-fit linear equation determined by the (X, Y) pairs."))
                .HasAnnotation("Npgsql:StorageParameter:schema_locked", "true");
        ...
        modelBuilder.Entity<RequestActionType>(entity =>
        {
            ...
            entity
                .ToTable("request_action_type", tb => tb.HasComment("Calculates square of the correlation coefficient."))
                .HasAnnotation("Npgsql:StorageParameter:schema_locked", "true");
        ...
        modelBuilder.Entity<RequestEventLog>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("request_event_log", tb => tb.HasComment("Calculates slope of the least-squares-fit linear equation determined by the (X, Y) pairs."))
                .HasAnnotation("Npgsql:StorageParameter:schema_locked", "true");
        ...
        modelBuilder.Entity<RequestState>(entity =>
        {
            ...
            entity
                .ToTable("request_state", tb => tb.HasComment("Calculates slope of the least-squares-fit linear equation determined by the (X, Y) pairs."))
                .HasAnnotation("Npgsql:StorageParameter:schema_locked", "true");
        ...
        modelBuilder.Entity<RequestStatus>(entity =>
        {
            ...
            entity
                .ToTable("request_status", tb => tb.HasComment("Calculates slope of the least-squares-fit linear equation determined by the (X, Y) pairs."))
                .HasAnnotation("Npgsql:StorageParameter:schema_locked", "true");
        ...
        modelBuilder.Entity<RequestStatusHead>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("request_status_head", tb => tb.HasComment("Calculates slope of the least-squares-fit linear equation determined by the (X, Y) pairs."))
                .HasAnnotation("Npgsql:StorageParameter:schema_locked", "true");
        ...
        modelBuilder.Entity<RequestType>(entity =>
        {
            ...
            entity
                .ToTable("request_type", tb => tb.HasComment("Calculates square of the correlation coefficient."))
                .HasAnnotation("Npgsql:StorageParameter:schema_locked", "true");
        ...
        modelBuilder.Entity<SpatialRefSys>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("spatial_ref_sys", "pg_extension", tb => tb.HasComment("Shows all defined Spatial Reference Identifiers (SRIDs). Matches PostGIS' spatial_ref_sys table."));
